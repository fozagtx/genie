  ...
  const sections: Section[] = [
    {
      ...
      content: (
        <div className="doc-content">
          ...
          <p>
            Genie AI is a multi-agent AI system designed to automate code generation, reviews, and enhancements.
    ...
    },
    {
      ...
      content: (
        <div className="doc-content">
          <h2>Getting Started with Genie AI</h2>
    ...
    },
    {
      ...
      content: (
        <div className="doc-content">
          ...
          <h3>Overview</h3>
          <p>
            Genie AI includes a powerful AI image generation system powered by 
...
✅ Lightbox integration`}</pre>
          ...
          <p>Genie AI agents <strong>DO NOT</strong> use external image services:</p>
          <ul>
          ...
          <main className="docs-main">
            ...
            <div className="docs-footer">
              ...
              <div className="docs-footer-info">
                <p>Genie AI v1.0.0 | Last updated: {new Date().toLocaleDateString()}</p>
              </div>
            </div>
          </main>
        </div>

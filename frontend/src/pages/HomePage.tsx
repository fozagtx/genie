          ...
          <div className="mobile-warning-modal terminal-window">
            ...
            <div className="terminal-content mobile-warning-content">
              ...
              <p className="warning-message">
                Genie AI is best used on desktop for the optimal experience.
              </p>
        ...
        <div className="section-container">
          ...
          <div className="channels-grid">
            ...
            <div className="channel-card terminal-window">
              ...
              <h3>TELEGRAM BOT</h3>
              <p>Code on the go - @GenieAI_Bot for mobile development</p>
              <div className="channel-badges">
      ...
      <footer className="home-footer">
        <div className="footer-content">
          <div className="footer-text text-muted">
            GENIE AI © 2025 | NEXT-GENERATION AI DEVELOPMENT
          </div>
          <div className="footer-links">
            <a href="/docs" className="footer-link">DOCS</a>
            <span className="footer-separator">|</span>
            <a href="https://t.me/genie_ai_bot" className="footer-link" target="_blank" rel="noopener noreferrer">
              TELEGRAM
            </a>
            <span className="footer-separator">|</span>
            <a href="https://github.com/zaikaman/genie" className="footer-link">GITHUB</a>
          </div>
        </div>
      </footer>

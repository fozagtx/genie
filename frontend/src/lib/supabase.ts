...
if (!supabaseUrl || !supabaseAnonKey) {
  console.warn(
    '⚠️  Supabase environment variables not configured. Authentication features will be disabled.\n' +
    'Please set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in your .env file to enable auth features.'
  );
}
 ...
 * 
 * Note: If env vars are not set, creates a dummy client that won't work but won't crash the app
 */

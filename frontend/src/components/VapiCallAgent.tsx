      ...
      <div className="vapi-call-compact">
        {!isCallActive && !isConnecting ? (
          <button
            ...
            onClick={startCall}
            disabled={!user}
            title="Start voice call with Genie AI"
          >
            🎙️
          </button>
        ) : (
      ...
      <div className="call-agent-container">
        {!isCallActive && !isConnecting ? (
          <button
            ...
            onClick={startCall}
            disabled={!user}
            title={!user ? 'Please login to use voice assistant' : 'Start voice call with Genie AI'}
          >
            <span className="icon">🎤</span>
            <span className="text">Call Genie Agent</span>
          </button>
        ) : (
